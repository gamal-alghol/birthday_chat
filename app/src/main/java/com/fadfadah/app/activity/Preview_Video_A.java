...
import com.fadfadah.app.Filter.Filter_Adapter;
...
public class Preview_Video_A extends AppCompatActivity implements Player.EventListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(intent!=null){
            video_uri_intent=intent.getStringExtra("uri");
        }
...
findViewById(R.id.next_btn).setOnClickListener(new View.OnClickListener() {
    @Override
    public void onClick(View v) {
        findViewById(R.id.progress_prev).setVisibility(View.VISIBLE) ;
        Intent intent1 = new Intent(getApplicationContext(), UploadStatusServices.class);
        intent1.putExtra("uri", "" + video_uri_intent);
        intent1.putExtra("position", select_postion);
       ...
       Set_Player(video_uri_intent);
        ...
        adapter = new Filter_Adapter(this, filterTypes, new Filter_Adapter.OnItemClickListener() {
            ...
            public void onItemClick(View view, int postion, FilterType item) {
                ...
                Toast.makeText(getApplicationContext(),filterTypes.get(postion).name(),Toast.LENGTH_LONG).show();
